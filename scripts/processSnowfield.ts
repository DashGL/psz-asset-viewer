...
async function processArea(area: 'a' | 'b' | 'e' | 'z') {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`❄️  Processing Rioh Snowfield - Area ${area.toUpperCase()}`);
  ...
  const outputDir = join(OUTPUT_DIR, `snowfield_${area}`);
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📊 Summary for Snowfield ${area.toUpperCase()}`);
  console.log('='.repeat(60));
...
async function main() {
  console.log('🚀 PSZ Rioh Snowfield Processor (Scene 03)');
  console.log('Converting Snowfield NARC/NSBTX files to GLB format\n');
  ...
  console.log(`   - ${join(OUTPUT_DIR, 'snowfield_a')}`);
  console.log(`   - ${join(OUTPUT_DIR, 'snowfield_b')}`);
  console.log(`   - ${join(OUTPUT_DIR, 'snowfield_e')}`);
  console.log(`   - ${join(OUTPUT_DIR, 'snowfield_z')}`);
}
