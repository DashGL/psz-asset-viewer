...
async function processArea(area: 'a' | 'b' | 'e' | 'z') {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`🌿 Processing Ozette Wetlands - Area ${area.toUpperCase()}`);
  ...
  const outputDir = join(OUTPUT_DIR, `wetlands_${area}`);
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📊 Summary for Wetlands ${area.toUpperCase()}`);
  console.log('='.repeat(60));
...
async function main() {
  console.log('🚀 PSZ Ozette Wetlands Processor (Scene 02)');
  console.log('Converting Wetlands NARC/NSBTX files to GLB format\n');
  ...
  console.log(`   - ${join(OUTPUT_DIR, 'wetlands_a')}`);
  console.log(`   - ${join(OUTPUT_DIR, 'wetlands_b')}`);
  console.log(`   - ${join(OUTPUT_DIR, 'wetlands_e')}`);
  console.log(`   - ${join(OUTPUT_DIR, 'wetlands_z')}`);
}
