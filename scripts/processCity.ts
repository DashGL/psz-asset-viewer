...
async function processArea(area: 'a' | 'e') {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`🏙️  Processing City - Area ${area.toUpperCase()}`);
  ...
  const outputDir = join(OUTPUT_DIR, `city_${area}`);
  ...
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📊 Summary for City ${area.toUpperCase()}`);
  console.log('='.repeat(60));
...
async function main() {
  console.log('🚀 PSZ City Processor (Scene 00)');
  console.log('Converting City NARC/NSBTX files to GLB format\n');
